...
*/
  ...
  public:
    ...
    void resized() override
    {
      ...
      int buttonHeight = 50; // Height of the button strip at the bottom
      int buttonSize = 40;
      int margin = 5;

      // Editor takes the top portion
      if (editor)
      {
  ...
  public:
        ...
        host(hostApp)
    {
      ...
      cout << "  Creating routing buttons..." << endl;
      // Create routing buttons
      auto midiBtn = std::make_unique<RoutingButton>(
        RoutingButton::MidiKeyboard, lpind, hostApp);
      auto virtualBtn = std::make_unique<RoutingButton>(
      ...
      // Get references to the buttons before moving the wrapper
      midiKeyboardButton = wrapper->getMidiButton().get();
      virtualKeyboardButton = wrapper->getVirtualButton().get();

      // Calculate the size: editor size + button strip height
