...
static PyTypeObject PyJuceAudioHostType = {
    ...
    "juce_audio.JuceAudioHost",             /* tp_name */
    sizeof(PyJuceAudioHost),                /* tp_basicsize */
    0,                                       /* tp_itemsize */
    (destructor)PyJuceAudioHost_dealloc,    /* tp_dealloc */
    0,                                       /* tp_vectorcall_offset (tp_print in older versions) */
    0,                                       /* tp_getattr */
    0,                                       /* tp_setattr */
    0,                                       /* tp_as_async (tp_compare in older versions) */
    0,                                       /* tp_repr */
    0,                                       /* tp_as_number */
    0,                                       /* tp_as_sequence */
    0,                                       /* tp_as_mapping */
    ...
    0,                                       /* tp_iter */
    0,                                       /* tp_iternext */
    PyJuceAudioHost_methods,                /* tp_methods */
    0,                                       /* tp_members */
    0,                                       /* tp_getset */
    0,                                       /* tp_base */
    0,                                       /* tp_dict */
    ...
    0,                                       /* tp_descr_set */
    0,                                       /* tp_dictoffset */
    (initproc)PyJuceAudioHost_init,         /* tp_init */
    0,                                       /* tp_alloc */
    PyJuceAudioHost_new,                    /* tp_new */
    0,                                       /* tp_free */
    0,                                       /* tp_is_gc */
    0,                                       /* tp_bases */
    0,                                       /* tp_mro */
...
static PyModuleDef juce_audio_module = {
    ...
    "juce_audio",                            /* m_name */
    "Python bindings for JUCE audio plugin hosting", /* m_doc */
    -1,                                      /* m_size */
    nullptr,                                 /* m_methods */
    nullptr,                                 /* m_slots */
    nullptr,                                 /* m_traverse */
