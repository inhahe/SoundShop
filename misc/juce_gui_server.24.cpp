...
#define READFROMPIPE(type) readFromPipe<type>()
  ...
  struct loadPluginR {uint32_t success = false; string errmsg; string name; int32_t lpindex = -3; uint32_t uid = -3;}; //todo: change uint to int for lpindex in pipe communication
